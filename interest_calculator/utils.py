...
'''
Utils to get returns in a certain period of time.
I provide get_monthly_returns or geometric_formula as alternatives
'''


def get_monthly_returns(initial_deposit, monthly_deposit, yearly_interest_rate, months):
    '''
    Calculate interest returns for each month
    '''
    initial_deposit = float(initial_deposit)
    monthly_deposit = float(monthly_deposit)
    monthly_interest_rate = float(yearly_interest_rate)/12/100
...
def get_yearly_returns(initial_deposit, monthly_deposit, yearly_interest_rate, years):
    '''
...
def geometric_formula(initial_deposit, monthly_deposit, yearly_interest_rate, months):
    '''
